        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PricePerDaily = table.Column<int>(type: "int", nullable: true),
                    PricePerHour = table.Column<int>(type: "int", nullable: true),
                    NannyImagePath = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Nanny", x => x.NannyId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChildGender = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MedicalHistoryAboutChild = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HomeSpace = table.Column<int>(type: "int", nullable: true),
                    NumOfLivingRoom = table.Column<int>(type: "int", nullable: true),
                    NumOfDinningRoom = table.Column<int>(type: "int", nullable: true),
                    NumOfBedRoom = table.Column<int>(type: "int", nullable: true),
                    NumOfLaundryRoom = table.Column<int>(type: "int", nullable: true),
                    NumOfKitchenRoom = table.Column<int>(type: "int", nullable: true),
                    NumOfBathRoom = table.Column<int>(type: "int", nullable: true),
                    BuildingName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AptNo = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryNanny", x => new { x.CategoriesId, x.NanniesNannyId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryNanny_NanniesNannyId",
                table: "CategoryNanny",
